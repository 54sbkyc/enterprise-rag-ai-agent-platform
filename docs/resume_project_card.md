...
- 正式版本：[v1.6.0](https://github.com/54sbkyc/enterprise-rag-ai-agent-platform/releases/tag/v1.6.0)
...
- 建设 AI 可观测与工程交付能力，记录生成/降级方式、Token 和成本，使用 161 项 pytest、真实 pgvector 集成测试、Playwright、RAG 质量门禁和 GitHub Actions 容器实跑保障回归质量。
...
`Python`、`FastAPI`、`RAG`、`BM25`、`Embedding`、`pgvector`、`HNSW`、`Hybrid Search`、`MRR`、`AI Agent`、`工具调用`、`AI 可观测`、`权限控制`、`Docker`、`自动化测试`
